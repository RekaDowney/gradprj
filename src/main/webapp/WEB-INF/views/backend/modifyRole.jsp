...
<form role="form" id="roleForm" style="width: 100%;height: 100%;padding-left: 10px;">
    ...
    <div class="form-group">
        ...
        <input id="roleName" type="text" name="roleName" value="${role.roleName}" class="form-control"
               style="width: 200px;"/>
    </div>
    <div class="form-group">
        <label for="roleNameCn">角色中文名称</label>
        <input id="roleNameCn" type="text" name="roleNameCn" value="${role.roleNameCn}" class="form-control"
               style="width: 200px;"/>
    </div>
    <div class="form-group">
        <label for="remarks">备注</label>
        <textarea id="remarks" name="remarks" class="form-control"
                  style="width: 200px;height: 200px;">${role.remarks}</textarea>
...
<script type="text/javascript">
    ...
    $('#roleForm').on('click', '#create', function () {
        if (validate()) {
            ...
            $.ajax({
                url: "${baseUrl}/role/${role.id}/modify",
                type: "POST",
                data: formData,
                async: false,
                cache: false,
