...
<form role="form" id="categoryForm" style="width: 100%;height: 100%;padding-left: 10px;">
    ...
    <div class="form-group">
        ...
        <input id="permName" type="text" name="permName" class="form-control" style="width: 200px;"/>
    </div>
    <div class="form-group">
        <label for="weight">栏目权重（权重越大排序越靠后）</label>
        <input id="weight" type="text" name="weight" class="form-control" style="width: 200px;"/>
    </div>
    <div class="form-group">
        该栏目是否可以上传文档
        <label>
...
<script type="text/javascript">
    ...
    function validate() {
        ...
        var weight = $('#weight');
        if (!$.fn.isPureNumberString(weight)) {
