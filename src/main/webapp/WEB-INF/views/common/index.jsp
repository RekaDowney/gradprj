...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">个人中心</strong>
                                    </span>
                                </span>
                        </a>
                    </div>
                    <div class="logo-element">个人中心
                    </div>
                </li>
                ...
                <li>
                    <a class="J_menuItem" href="${baseUrl}/account/doc/page">
                        <i class="fa fa-home"></i>
                        <span class="nav-label">文档列表</span>
                    </a>
                </li>
                <li>
                    <a class="J_menuItem" href="${baseUrl}/account/pwd/modify">
                        <i class="fa fa-home"></i>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <%-- 进入管理页面的时候就立刻打开列表页的 iframe --%>
        <div class="row J_mainContent" id="content-main">
            <iframe id="J_iframe" width="100%" height="100%" src="${baseUrl}/account/doc/page" frameborder="0"
                    seamless></iframe>
        </div>
